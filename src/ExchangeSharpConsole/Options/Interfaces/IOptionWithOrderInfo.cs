...
namespace ExchangeSharpConsole.Options.Interfaces
{
	public interface IOptionWithOrderInfo : IOptionPerMarketSymbol
	{
		...
		[Option(
				"stop-price",
				HelpText = "The price to trigger a stop.\n"
		...
		[Option(
				"margin",
				Default = false,
				HelpText = "Whether the order is a margin order. Not all exchanges support margin orders, so this parameter may be ignored.\n"
		...
		[Option(
				"round",
				Default = true,
				HelpText = "Whether the amount should be rounded.\n"
